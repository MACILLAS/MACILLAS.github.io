let settings = {
	...
	"results_ig4": [
		{"thumb": "potree/results/results_ig4/SDIC_Lab/SDIC_Lab.png", "label": "SDIC Lab", "url": "potree/results/results_ig4/SDIC_Lab/SDIC_Lab.html"},
		{"thumb": "potree/results/results_ig4/UW_Structures_Lab/UW_Structures_Lab.png", "label": "Structures Lab", "url": "potree/results/results_ig4/UW_Structures_Lab/UW_Structures_Lab.html"},
		{"thumb": "potree/results/results_ig4/360_ParkSt/bridge_of_shame.png", "label": "Park St. Bridge", "url": "potree/360_ParkSt/park_st_bridge.html"}
	],
	"results_faro": [
...
function includeRobenResults(){
	...
	for(let result of settings.results_ig4){
		resultCode += `
		<a href="${result.url}" target="_blank" style="hhdisplay: inline-block">
			<div class="thumb2" style="background-image: url('${result.thumb}'); ">
				<div class="thumb-label">${result.label}</div>
			</div>
		</a>
